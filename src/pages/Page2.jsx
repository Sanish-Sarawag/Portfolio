...
const Page2 = () => {
  ...
  return (
    <div id='section2' className='bg-white text-center text-black p-18'>

      <div className='rotateText mt-40'>
        <h1 className='text-[32vw] text-black font-[anzo4] tracking-tighter leading-[28vw]'>IMPACTFUL</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[32vw] text-black font-[anzo4] tracking-tighter leading-[28vw]'>DESIGN</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[32vw] text-black font-[anzo4] tracking-tighter leading-[28vw]'>IS THE</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[32vw] text-black font-[anzo4] tracking-tighter leading-[28vw]'>DESIGN</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[32vw] text-black font-[anzo4] tracking-tighter leading-[28vw]'>THAT</h1>
      </div>
      <div className='rotateText'>
        <h1 className='text-[32vw] text-black font-[anzo4] tracking-tighter leading-[28vw]'>WORKS!</h1>
      </div>
